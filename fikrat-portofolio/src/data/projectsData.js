export const projectsData = [
  // --- Embedded & Desktop Dev ---
  {
    ...
    image: process.env.PUBLIC_URL + "/images/tesla-v11-fan-edit-1.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/maxresdefault.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/qt_js.jpg",
  ...
  },
  {
    ...
    category: "embedded_desktop_dev",
    description: "QT / C++",
    image: process.env.PUBLIC_URL + "/images/bwm_voice_operator.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/WhatsApp-Image-2023-10-13-at-12.27.00-PM.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/firmware.jpeg",
  ...
  // --- Deep Learning ---
  {
    ...
    image: process.env.PUBLIC_URL + "/images/download.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/Delineated-garbage-detection-area_Q320.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/1702344_7c04_2.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/Anomly1.png",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/humanfall.jpeg",
  ...
  // --- OpenCV & Robotics ---
  {
    ...
    image: process.env.PUBLIC_URL + "/images/download (3).jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/download_opencv.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/opencv.jpg",
    link: "https://github.com/fikratgasimovsoftwareengineer/Tracking-with-Opencv",
    btnText: "Source Code"
  },
  {
    ...
    category: "openCV_robotics",
    description: "ROS / C++",
    image: process.env.PUBLIC_URL + "/images/1.23.19-Drones-Under-200.jpg",
    link: "https://github.com/fikratgasimovsoftwareengineer/Robots_UGV",
    btnText: "Watch Demo"
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/domestic_robo.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/yolov7-webapp.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/bert.jpg",
  ...
  // --- Avatar AI ---
  {
    ...
    image: process.env.PUBLIC_URL + "/images/avatar_image.jpg",
  ...
  // --- Udemy Instructor ---
  {
    ...
    image: process.env.PUBLIC_URL + "/images/udemy.jpg",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/images/llm.jpeg",
